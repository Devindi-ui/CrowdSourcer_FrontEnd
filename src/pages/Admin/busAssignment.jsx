  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-sky-600 p-6">
      ...
      <button
        ...
        bg-white/90 backdrop-blur-md text-slate-800 px-4 py-2 rounded-full shadow-lg"
      >
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mt-10">
          ...
          <div className="space-y-4">
            {assignments.map(a => (
              <div
                key={a.assignment_id}
                className="flex justify-between p-4 rounded-xl border hover:shadow-lg transition"
              >
                <div>
