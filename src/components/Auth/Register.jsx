...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.data?.success || res.data?.data || res.status === 201 || res.status === 200) {
        ...
        <div className="relative min-h-screen flex items-center justify-center bg-black text-white p-6 overflow-hidden">
            ...
            <form 
                ...
                <button
                    ...
                    className="w-full bg-gradient-to-r from-yellow-500 via-yellow-400 to-yellow-600 text-black py-3 rounded-2xl font-semibold hover:scale-[1.03] hover:shadow-[0_0_25px_rgba(255,215,0,0.4)] transition-all duration-300 disabled:opacity-60"
                >
